...
ggplot(data = pData, aes(x = `GEO.ACL00`, y = `time`,fill=`SEX`, label = time)) + 
                ...
                labs(title = "Timpe Spent Eating", fill = "Gender")
...
ggplot(data = pData, aes(x = `GEO.ACL00`, y = `time`,fill=`SEX`, label = time)) + 
                ...
                labs(title = "Timpe Spent Dish Washing", fill = "Gender")
...
**but they seem to prefer the ladies do the dishes. Or maybe they wash dishes much faster than females?**
...
**It must be noted that this sample may not be representative of the European population.**
